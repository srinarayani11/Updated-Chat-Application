          ...
          t2.exports = function() {
            ...
            var t3 = { 34: function(t4, e3, n3) {
              ...
              var o3 = n3(4576), r3 = n3(9039), i2 = o3.RegExp, a2 = !r3(function() {
                ...
                for (var s2 in t5 && (a3.hasIndices = "d"), a3) r4(s2, a3[s2]);
              ...
              a2("replace", function(t5, e4, n4) {
                ...
                return [function(t6, n5) {
                  ...
                  for (var C3, A2 = []; null !== (C3 = b2(a3, s3)) && (S2(A2, C3), I3); ) "" === d2(C3[0]) && (a3.lastIndex = v2(s3, p2(a3.lastIndex), y3));
                  for (var M2, D2 = "", T2 = 0, j2 = 0; j2 < A2.length; j2++) {
                    for (var N, R = d2((C3 = A2[j2])[0]), L = x2(E2(f2(C3.index), s3.length), 0), B = [], K = 1; K < C3.length; K++) S2(B, void 0 === (M2 = C3[K]) ? M2 : String(M2));
                    var _ = C3.groups;
                    if (h3) {
                      var F = O2([R], B, L, s3);
                      void 0 !== _ && S2(F, _), N = d2(o3(r4, void 0, F));
                    } else N = g2(R, s3, L, B, _, r4);
              ...
              (s2.versions || (s2.versions = [])).push({ version: "3.44.0", mode: o3 ? "pure" : "global", copyright: "© 2014-2025 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.44.0/LICENSE", source: "https://github.com/zloirock/core-js" });
            ...
            var D = function() {
              return t4 = function t5(e4, n4) {
                ...
                window.oncontextmenu = function(t5) {
                  var e4;
                  if (null !== (e4 = t5.target.classList) && void 0 !== e4 && e4.contains("hg-button")) return t5.preventDefault(), t5.stopPropagation(), false;
                };
